...
var o23555 = temp__5455__auto__;
var temp__5455__auto____$1 = (o23555["core"]);
if(cljs.core.truth_(temp__5455__auto____$1)){
var o23556 = temp__5455__auto____$1;
return (o23556["js_reserved_QMARK_"]);
} else {
return null;
}
} else {
...
var o__22666__auto__ = f;
return (o__22666__auto__["toString"]).call(o__22666__auto__);
} else {
return "";
}
}catch (e23557){var _ = e23557;
return "";
}});
...
try{var o__22666__auto___23559 = t;
(o__22666__auto___23559["cljs$lang$ctorPrWriter"]).call(o__22666__auto___23559,t,writer);
}catch (e23558){var __23560 = e23558;
}
...
var char_code = (function (){var o__22666__auto__ = (new String(char$));
return (o__22666__auto__["charCodeAt"]).call(o__22666__auto__,(0));
})();
var num_code = (char_code - (48));
var subscript_code = ((8320) + num_code);
var o__22666__auto__ = String;
return (o__22666__auto__["fromCharCode"]).call(o__22666__auto__,subscript_code);
});
/**
...
var num_code = (char_code - (48));
var superscript_code = (function (){var G__23561 = num_code;
switch (G__23561) {
case (1):
return (185);
...
var o__22666__auto__ = String;
return (o__22666__auto__["fromCharCode"]).call(o__22666__auto__,superscript_code);
});
/**
...
}catch (e23563){var _e__22673__auto__ = e23563;
return false;
}})())){
...
var vec__23564 = devtools.munging.parse_fn_source.call(null,fn_source);
var name__$1 = cljs.core.nth.call(null,vec__23564,(0),null);
...
if(cljs.core.truth_(temp__5455__auto__)){
var o23567 = temp__5455__auto__;
var temp__5455__auto____$1 = (o23567["dependencies_"]);
if(cljs.core.truth_(temp__5455__auto____$1)){
var o23568 = temp__5455__auto____$1;
return (o23568["nameToPath"]);
} else {
return null;
}
} else {
...
var len__4499__auto___23575 = arguments.length;
var i__4500__auto___23576 = (0);
while(true){
if((i__4500__auto___23576 < len__4499__auto___23575)){
args__4502__auto__.push((arguments[i__4500__auto___23576]));

var G__23577 = (i__4500__auto___23576 + (1));
i__4500__auto___23576 = G__23577;
continue;
} else {
}
break;
...
devtools.munging.detect_namespace_prefix.cljs$core$IFn$_invoke$arity$variadic = (function (tokens,p__23571){
var vec__23572 = p__23571;
var ns_detector = cljs.core.nth.call(null,vec__23572,(0),null);
...
var G__23578 = cljs.core.concat.call(null,new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.last.call(null,remaining_tokens)], null),name_tokens);
var G__23579 = cljs.core.butlast.call(null,remaining_tokens);
name_tokens = G__23578;
remaining_tokens = G__23579;
continue;
}
}
break;
...
/** @this {Function} */
devtools.munging.detect_namespace_prefix.cljs$lang$applyTo = (function (seq23569){
var G__23570 = cljs.core.first.call(null,seq23569);
var seq23569__$1 = cljs.core.next.call(null,seq23569);
var self__4486__auto__ = this;
return self__4486__auto__.cljs$core$IFn$_invoke$arity$variadic(G__23570,seq23569__$1);
});
...
var vec__23583 = cljs.core.split_with.call(null,(function (p1__23582_SHARP_){
return cljs.core.not_EQ_.call(null,p1__23582_SHARP_,"arity");
}),tokens);
var prefix_tokens = cljs.core.nth.call(null,vec__23583,(0),null);
var arity_tokens = cljs.core.nth.call(null,vec__23583,(1),null);
...
var vec__23586 = devtools.munging.detect_namespace_prefix.call(null,remaining_tokens,detector);
var protocol_ns = cljs.core.nth.call(null,vec__23586,(0),null);
var name_and_method_tokens = cljs.core.nth.call(null,vec__23586,(1),null);
if(cljs.core.empty_QMARK_.call(null,protocol_ns)){
var G__23589 = cljs.core.rest.call(null,remaining_tokens);
var G__23590 = cljs.core.conj.call(null,name_tokens,cljs.core.first.call(null,remaining_tokens));
remaining_tokens = G__23589;
name_tokens = G__23590;
continue;
} else {
...
var vec__23593 = devtools.munging.strip_arity.call(null,tokens);
var tokens__$1 = cljs.core.nth.call(null,vec__23593,(0),null);
var arity = cljs.core.nth.call(null,vec__23593,(1),null);
var vec__23596 = devtools.munging.detect_namespace_prefix.call(null,tokens__$1,effective_detector);
var fn_ns = cljs.core.nth.call(null,vec__23596,(0),null);
var tokens__$2 = cljs.core.nth.call(null,vec__23596,(1),null);
var vec__23599 = devtools.munging.parse_protocol.call(null,tokens__$2,effective_detector);
var fn_name_tokens = cljs.core.nth.call(null,vec__23599,(0),null);
var protocol_ns = cljs.core.nth.call(null,vec__23599,(1),null);
var protocol_name = cljs.core.nth.call(null,vec__23599,(2),null);
var protocol_method_tokens = cljs.core.nth.call(null,vec__23599,(3),null);
...
var vec__23605 = result;
var munged_ns = cljs.core.nth.call(null,vec__23605,(0),null);
var munged_name__$1 = cljs.core.nth.call(null,vec__23605,(1),null);
var munged_protocol_ns = cljs.core.nth.call(null,vec__23605,(2),null);
var munged_protocol_name = cljs.core.nth.call(null,vec__23605,(3),null);
var munged_protocol_method = cljs.core.nth.call(null,vec__23605,(4),null);
var arity = cljs.core.nth.call(null,vec__23605,(5),null);
...
if(cljs.core.truth_(temp__5455__auto__)){
var vec__23609 = temp__5455__auto__;
var munged_name = cljs.core.nth.call(null,vec__23609,(0),null);
var args = cljs.core.nth.call(null,vec__23609,(1),null);
var vec__23612 = devtools.munging.break_and_demunge_name.call(null,munged_name);
var ns = cljs.core.nth.call(null,vec__23612,(0),null);
var name = cljs.core.nth.call(null,vec__23612,(1),null);
...
var G__23615 = (arity + (1));
var G__23616 = (function (){var temp__5455__auto__ = devtools.munging.get_fn_fixed_arity.call(null,f,arity);
if(cljs.core.truth_(temp__5455__auto__)){
...
devtools.munging.review_arity = (function devtools$munging$review_arity(p__23617){
var vec__23618 = p__23617;
var arity = cljs.core.nth.call(null,vec__23618,(0),null);
var arity_fn = cljs.core.nth.call(null,vec__23618,(1),null);
...
return cljs.core.get.call(null,arities,p1__23621_SHARP_);
});})(sorted_keys))
,sorted_keys);
...
return cljs.core.drop.call(null,(2),p1__23622_SHARP_);
...
var args__4502__auto__ = [];
var len__4499__auto___23629 = arguments.length;
var i__4500__auto___23630 = (0);
while(true){
if((i__4500__auto___23630 < len__4499__auto___23629)){
args__4502__auto__.push((arguments[i__4500__auto___23630]));

var G__23631 = (i__4500__auto___23630 + (1));
i__4500__auto___23630 = G__23631;
continue;
} else {
}
break;
...
devtools.munging.arities_to_args_lists.cljs$core$IFn$_invoke$arity$variadic = (function (arities,p__23625){
var vec__23626 = p__23625;
var humanize_QMARK_ = cljs.core.nth.call(null,vec__23626,(0),null);
...
/** @this {Function} */
devtools.munging.arities_to_args_lists.cljs$lang$applyTo = (function (seq23623){
var G__23624 = cljs.core.first.call(null,seq23623);
var seq23623__$1 = cljs.core.next.call(null,seq23623);
var self__4486__auto__ = this;
return self__4486__auto__.cljs$core$IFn$_invoke$arity$variadic(G__23624,seq23623__$1);
});
...
var map__23634 = options;
var map__23634__$1 = ((((!((map__23634 == null)))?(((((map__23634.cljs$lang$protocol_mask$partition0$ & (64))) || ((cljs.core.PROTOCOL_SENTINEL === map__23634.cljs$core$ISeq$))))?true:false):false))?cljs.core.apply.call(null,cljs.core.hash_map,map__23634):map__23634);
var include_ns_QMARK_ = cljs.core.get.call(null,map__23634__$1,new cljs.core.Keyword(null,"include-ns?","include-ns?",-341372810));
var include_protocol_ns_QMARK_ = cljs.core.get.call(null,map__23634__$1,new cljs.core.Keyword(null,"include-protocol-ns?","include-protocol-ns?",989250951));
var silence_common_protocols_QMARK_ = cljs.core.get.call(null,map__23634__$1,new cljs.core.Keyword(null,"silence-common-protocols?","silence-common-protocols?",2012431893));
var ns_detector = cljs.core.get.call(null,map__23634__$1,new cljs.core.Keyword(null,"ns-detector","ns-detector",-2041592760));
var vec__23635 = devtools.munging.break_and_demunge_name.call(null,munged_name,ns_detector);
var fn_ns = cljs.core.nth.call(null,vec__23635,(0),null);
var fn_name = cljs.core.nth.call(null,vec__23635,(1),null);
var protocol_ns = cljs.core.nth.call(null,vec__23635,(2),null);
var protocol_name = cljs.core.nth.call(null,vec__23635,(3),null);
var protocol_method = cljs.core.nth.call(null,vec__23635,(4),null);
var arity = cljs.core.nth.call(null,vec__23635,(5),null);
...
var o__22666__auto__ = f;
return (o__22666__auto__["getBasis"]).call(o__22666__auto__);
});
/**
...
}catch (e23639){var _e__22673__auto__ = e23639;
...
var G__23640 = (obj[cljs.core.first.call(null,path)]);
var G__23641 = cljs.core.rest.call(null,path);
obj = G__23640;
path = G__23641;
continue;
} else {
...
return (function (accum,p__23642){
var vec__23643 = p__23642;
var bit = cljs.core.nth.call(null,vec__23643,(0),null);
var protocol = cljs.core.nth.call(null,vec__23643,(1),null);
...
devtools.munging.convert_to_protocol_descriptor = (function devtools$munging$convert_to_protocol_descriptor(fast_QMARK_,p__23646){
var vec__23647 = p__23646;
var ns = cljs.core.nth.call(null,vec__23647,(0),null);
var name = cljs.core.nth.call(null,vec__23647,(1),null);
var selector = cljs.core.nth.call(null,vec__23647,(2),null);
...
return (function (p__23651){
var vec__23652 = p__23651;
var munged_name = cljs.core.nth.call(null,vec__23652,(0),null);
var matches__$1 = cljs.core.nth.call(null,vec__23652,(1),null);
...
var sorted_fns = cljs.core.map.call(null,((function (name,sorted_matches,vec__23652,munged_name,matches__$1,key_prefix,pattern,all_keys,matches,methods$,match_to_arity,match_arity_comparator){
return (function (p1__23650_SHARP_){
return (obj[cljs.core.first.call(null,p1__23650_SHARP_)]);
});})(name,sorted_matches,vec__23652,munged_name,matches__$1,key_prefix,pattern,all_keys,matches,methods$,match_to_arity,match_arity_comparator))
,sorted_matches);
...
//# sourceMappingURL=munging.js.map?rel=1535274130712
