...
}catch (e25625){var _e = e25625;
return false;
}});
devtools.hints.type_error_to_string = (function devtools$hints$type_error_to_string(self){
var temp__5455__auto___25628 = devtools.hints.get_processed_errors_BANG_.call(null);
if(cljs.core.truth_(temp__5455__auto___25628)){
var seen_errors_25629 = temp__5455__auto___25628;
if(cljs.core.truth_(seen_errors_25629.has(self))){
} else {
seen_errors_25629.add(self);

var temp__5457__auto___25630 = devtools.hints.error_object_sense.call(null,self);
if(cljs.core.truth_(temp__5457__auto___25630)){
var sense_25631 = temp__5457__auto___25630;
self.message = [cljs.core.str.cljs$core$IFn$_invoke$arity$1(self.message),", a sanity hint:\n",cljs.core.str.cljs$core$IFn$_invoke$arity$1(sense_25631)].join('');
} else {
}
}
} else {
...
//# sourceMappingURL=hints.js.map?rel=1535274134401
