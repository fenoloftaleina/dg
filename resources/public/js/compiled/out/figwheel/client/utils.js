...
return (new CustomEvent(event_name,(function (){var obj29056 = {"detail":data};
return obj29056;
})()));
} else {
...
var f = (function (){var pred__29063 = cljs.core._EQ_;
var expr__29064 = (cljs.core.truth_(figwheel.client.utils.html_or_react_native_env_QMARK_.call(null))?level:new cljs.core.Keyword(null,"info","info",-317069002));
if(cljs.core.truth_(pred__29063.call(null,new cljs.core.Keyword(null,"warn","warn",-436710552),expr__29064))){
return ((function (pred__29063,expr__29064){
return (function (p1__29057_SHARP_){
return console.warn(p1__29057_SHARP_);
});
;})(pred__29063,expr__29064))
} else {
if(cljs.core.truth_(pred__29063.call(null,new cljs.core.Keyword(null,"debug","debug",-1608172596),expr__29064))){
return ((function (pred__29063,expr__29064){
return (function (p1__29058_SHARP_){
return console.debug(p1__29058_SHARP_);
});
;})(pred__29063,expr__29064))
} else {
if(cljs.core.truth_(pred__29063.call(null,new cljs.core.Keyword(null,"error","error",-978969032),expr__29064))){
return ((function (pred__29063,expr__29064){
return (function (p1__29059_SHARP_){
return console.error(p1__29059_SHARP_);
});
;})(pred__29063,expr__29064))
} else {
return ((function (pred__29063,expr__29064){
return (function (p1__29060_SHARP_){
return console.log(p1__29060_SHARP_);
});
;})(pred__29063,expr__29064))
}
}
...
figwheel.client.utils.eval_helper = (function figwheel$client$utils$eval_helper(code,p__29067){
...
return new_def.callback(p1__29070_SHARP_);
});})(new_def))
);
...
return (function (p__29071){
var vec__29072 = p__29071;
var ky = cljs.core.nth.call(null,vec__29072,(0),null);
...
//# sourceMappingURL=utils.js.map?rel=1535274136591
